...
public class TestaListaEncadeada {
	...
	public void insertsearchTeste() {
		...
		assertTrue(listaEnc.search(20).getProximo().isNull());
		listaEnc.insert(15);
		...
		assertTrue(listaEnc.search(15).getProximo().isNull());
		listaEnc.insert(3);
		...
		assertTrue(listaEnc.search(3).getProximo().isNull());
		listaEnc.insert(90);
		...
		assertTrue(listaEnc.search(90).getProximo().isNull());
		listaEnc.insert(100);
		...
		assertTrue(listaEnc.search(100).getProximo().isNull());
		listaEnc.insert(73);
		...
		assertTrue(listaEnc.search(73).getProximo().isNull());
		listaEnc.insert(29);
		...
		assertTrue(listaEnc.search(29).getProximo().isNull());
