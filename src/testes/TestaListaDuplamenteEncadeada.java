...
public class TestaListaDuplamenteEncadeada {
	...
	public void removeUltimoTest() {
		...
		NodoListaDuplamenteEncadeada<Integer> cauda = (NodoListaDuplamenteEncadeada<Integer>) ((ListaDuplamenteEncadeadaImpl<Integer>)listaDuplaEnc).search(15);
		assertEquals(new NodoListaDuplamenteEncadeada<Integer>(33), cauda.getAnterior());
		
		// ... System.out.println(listaDuplaEnc.sucessor(15));
	...
	public void removePrimeiro() {
		...
		assertNull(cauda.getAnterior().getChave());
